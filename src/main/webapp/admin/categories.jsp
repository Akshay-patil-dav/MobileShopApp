        ...
        <body class="admin-body">
            ...
            <div class="admin-content">
                ...
                <div class="admin-main p-4">
                    <h4 class="fw-bold mb-4"><i class="fas fa-tags me-2"></i>Manage Categories</h4>

                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="admin-card">
                                <h5 class="fw-bold mb-3">${not empty editCategory ? 'Edit' : 'Add'} Category</h5>
                                <form action="${pageContext.request.contextPath}/admin/categories" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="categoryName" class="form-control"
                                            value="${editCategory.categoryName}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Description</label>
                                        <textarea name="description" class="form-control"
                                            rows="3">${editCategory.description}</textarea>
                                    </div>
                                    <button type="submit" class="btn btn-primary w-100">
                                        <i class="fas fa-save me-2"></i>${not empty editCategory ? 'Update' : 'Add'}
                                        Category
                                    </button>
                                    <c:if test="${not empty editCategory}">
                                            ...
                                            <c:forEach var="cat" items="${categories}" varStatus="loop">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/admin/categories?action=delete&id=${cat.categoryId}"
